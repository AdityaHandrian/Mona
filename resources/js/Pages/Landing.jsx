        ...
        >
            ...
            <section className="text-center py-20 max-[768px]:py-16 max-[425px]:py-12">
                <div className="max-w-[1500px] mx-auto px-6 max-[425px]:px-4">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl max-[425px]:text-2xl font-bold text-[#2C2C2C] leading-tight mb-6 max-[425px]:mb-4">
                        Take Full Control of Your{' '}
                        <span className="text-[#058743]">Financial Future</span>
                    </h1>
                    
                    <p className="text-xl lg:text-xl max-[768px]:text-lg max-[425px]:text-base text-[#2C2C2C] mb-8 max-[425px]:mb-6 max-w-2xl mx-auto leading-relaxed">
                        ...
                        <Link
                            href={route('register')}
                            className="inline-block bg-[#058743] text-white px-10 max-[425px]:px-6 py-4 max-[425px]:py-3 rounded-lg text-xl max-[425px]:text-lg font-semibold hover:bg-[#046635] transition-colors duration-200"
                        >
                            Sign Up For Free
                        </Link>
                        </div>
            ...
            <section className="py-20 max-[768px]:py-16 max-[425px]:py-12">
                <div className="max-w-[1500px] mx-auto px-6 max-[425px]:px-4">
                    <div className="text-center mb-16 max-[425px]:mb-12">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl max-[425px]:text-2xl font-bold text-[#2C2C2C] mb-4 max-[425px]:mb-3">
                            Everything You Need in One Place
                        </h2>
                        <p className="text-lg lg:text-xl max-[425px]:text-base text-[#2C2C2C] max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-[768px]:gap-6 max-[425px]:gap-4">
                        {/* Financial Dashboard */}
                        <div className="bg-white rounded-2xl p-8 max-[768px]:p-6 max-[425px]:p-4 border border-[#E0E0E0] hover:shadow-lg transition-shadow duration-200">
